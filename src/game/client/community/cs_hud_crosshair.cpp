...
DECLARE_HUDELEMENT(CHudCSCrosshair);

CHudCSCrosshair::CHudCSCrosshair( const char *pElementName ) : CHudCrosshair("CHudCrosshair")
{
...
void CHudCSCrosshair::ApplySchemeSettings(IScheme *scheme)
{
...
void CHudCSCrosshair::LevelShutdown(void)
{
...
void CHudCSCrosshair::Init()
{
	m_iCrosshairTextureID = vgui::surface()->CreateNewTextureID();
}

void CHudCSCrosshair::SetCrosshair(CHudTexture *texture, Color& clr)
{
	m_pCrosshair = texture;
	m_clrCrosshair = clr;
}

bool CHudCSCrosshair::ShouldDraw()
{
...
void CHudCSCrosshair::Paint()
{
	...
	else
	{
		...
		Color clr_nightvision( 250, 50, 50, 255 );
		...
		vgui::surface()->DrawSetColor( pPlayer->m_bNightVisionOn ? clr_nightvision : clr );
