...
protected:
	...
	CPanelAnimationVarAliasType( float, m_flLineHeight, "LineHeight", "18", "proportional_float" );
	...
	CPanelAnimationVar( Color, m_clrIcon, "IconColor", "DeathIconColor" );
	CPanelAnimationVar( Color, m_clrBaseBGColor, "BaseBackgroundColor", "PanelBackground" );
	CPanelAnimationVar( Color, m_clrLocalBGColor, "LocalBackgroundColor", "PanelBackground" );
